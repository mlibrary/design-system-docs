...
There is no set maximum number of items that call for pagination, but you can use it anytime there’s too many results to show on one page or within one scroll. When making pagination decisions, consider factors including load time, amount of information you need to display per item, and available screen space.

### Pagination with full details
...
* Ensuring touch targets are a minimum of 44px and not placing them too close together.
