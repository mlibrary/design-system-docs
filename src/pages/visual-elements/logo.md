...
## Block M version
 ...
 <img class="block-m" src="/img/MLibrary_block_M.png" alt="Square block M Library logo with a maize block M and Library presented in white text below the M on a dark blue background" width="216" height="230">
